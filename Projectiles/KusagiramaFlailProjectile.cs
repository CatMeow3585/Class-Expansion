...
{
    public class KusagiramaFlailProjectileBlade : ModProjectile
    {
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Kusagirama Flail");
		}
        ...
        public override void SetDefaults()
        {
            ...
            projectile.aiStyle = 16; // Set the aiStyle to that of a flail.
        }
        ...
        public override bool PreDraw(Microsoft.Xna.Framework.Graphics.SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Texture2D texture = ModLoader.GetTexture("UV/Projectiles/KusagiramaFlailProjectileChain");
