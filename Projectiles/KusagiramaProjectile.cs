...
namespace UV.Projectiles     //We need this to basically indicate the folder where it is to be read from, so you the texture will load correctly
{
    public class KusagiramaProjectile : ModProjectile
    {
        ...
        {
            projectile.width = 70;     //Set the hitbox width
